...
DataModel _$DataModelFromJson(Map<String, dynamic> json) {
  return _DataMdoel.fromJson(json);
}
...
/// @nodoc
abstract class _$$_DataMdoelCopyWith<$Res> implements $DataModelCopyWith<$Res> {
  factory _$$_DataMdoelCopyWith(
          _$_DataMdoel value, $Res Function(_$_DataMdoel) then) =
      __$$_DataMdoelCopyWithImpl<$Res>;
  @override
  $Res call(
      {int id,
      String title,
...
/// @nodoc
class __$$_DataMdoelCopyWithImpl<$Res> extends _$DataModelCopyWithImpl<$Res>
    implements _$$_DataMdoelCopyWith<$Res> {
  __$$_DataMdoelCopyWithImpl(
      _$_DataMdoel _value, $Res Function(_$_DataMdoel) _then)
      : super(_value, (v) => _then(v as _$_DataMdoel));

  @override
  _$_DataMdoel get _value => super._value as _$_DataMdoel;
...
/// @nodoc
@JsonSerializable()
class _$_DataMdoel implements _DataMdoel {
  _$_DataMdoel(
      {required this.id,
      required this.title,
      required this.worth,
  ...
  factory _$_DataMdoel.fromJson(Map<String, dynamic> json) =>
      _$$_DataMdoelFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$$_DataMdoelCopyWith<_$_DataMdoel> get copyWith =>
      __$$_DataMdoelCopyWithImpl<_$_DataMdoel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DataMdoelToJson(this);
  }
}

abstract class _DataMdoel implements DataModel {
  factory _DataMdoel(
      ...
      required final String gamerpower_url}) = _$_DataMdoel;

  factory _DataMdoel.fromJson(Map<String, dynamic> json) =
      _$_DataMdoel.fromJson;
